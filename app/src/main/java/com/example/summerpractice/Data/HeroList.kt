...
object HeroList {  val conversationSample = listOf(
    HeroCard(
        ...
        "Wolverine",
        "There is something that I really can do. What I do best. I'm not giving up. Never.",
        Color(red = 0xFF, green = 0xFF, blue = 0x33)
    ),
    HeroCard(
        "https://i.pinimg.com/originals/01/9d/59/019d59040b067a42b9412f47b424d202.png",
        "Thor",
        "I am Thor, the son of Odin, and as long as my heart is beating in my chest, I am... not a master of long and boring speeches.",
